...
import { buildModelSelectGroups, collectChannelModels, collectKnownModels, collectSettings, emptyChannel, emptySettings, emptyStorageProvider, filterModels, formatStorageBytes, getJsonError, mergeChannelApiKeys, modelCostCredits, modelSummary, normalizeChannel, normalizePrivateSetting, normalizePublicSetting, normalizeSettings, normalizeStorageProvider, parseTabJson, setModelCost, uniqueModels } from "./settings-utils";
                                ...
                                <Row gutter={16}>
                                    ...
                                    <Col span={24}>
                                        ...
                                        <Row gutter={16}>
                                            ...
                                            <Col xs={24}>
                                                <Form.Item name={["public", "modelChannel", "systemPrompts", "storyboardAgent"]} label="编剧 Agent 系统提示词">
                                                    <Input.TextArea rows={6} placeholder="控制分镜脚本生成的输出规范（场景/镜头/提示词 JSON 结构）" />
                                                </Form.Item>
                                            </Col>
                                            <Col xs={24}>
                                                <Form.Item name={["public", "modelChannel", "systemPrompts", "directorAgent"]} label="导演 Agent 系统提示词">
                                                    <Input.TextArea rows={6} placeholder="控制导演建议生成的输出规范（机位/景别/运镜/构图 JSON 结构）" />
                                                </Form.Item>
                                            </Col>
                                            <Col xs={24}>
                                                <Form.Item name={["public", "modelChannel", "systemPrompts", "executionScript"]} label="执行词生成系统提示词">
                                                    <Input.TextArea rows={6} placeholder="控制执行词提炼的输出规范（正文 + 步骤 JSON 结构）" />
                                                </Form.Item>
                                            </Col>
                                        </Row>
                        ...
                        <Form form={form} layout="vertical" initialValues={emptySettings} requiredMark={false}>
                            <Flex vertical gap={12}>
                                <Card
                                    ...
                                    title={
                                        <Space>
                                            <Image src="/icons/linuxdo.svg" alt="" width={18} height={18} />
                                            Linux.do 登录
                                        </Space>
                                    }
                                >

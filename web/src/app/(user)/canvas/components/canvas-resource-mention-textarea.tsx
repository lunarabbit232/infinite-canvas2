...
function ReferencePreview({ reference }: { reference: CanvasResourceReference }) {
    if (reference.kind === "image" && reference.previewUrl) return <Image src={reference.previewUrl} alt="" width={36} height={36} unoptimized className="size-9 rounded-md object-cover" />;

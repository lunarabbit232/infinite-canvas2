...
import { fetchAssetLibrary, type AssetLibraryItem, type AssetTag } from "@/services/api/assets";
...
export default function AssetLibraryPage() {
    ...
    const tagNames = (tags?: AssetTag[]) => (tags || []).map((t) => (typeof t === "string" ? t : t.name));
        ...
        <Card
            ...
            cover={
                <button type="button" className="block w-full text-left" onClick={onOpen}>
                    {cover ? (
                        <NextImage src={cover} alt={asset.title} width={400} height={300} unoptimized className="aspect-[4/3] w-full object-cover" />
                    ) : (
                ...
                <div className="p-4">
                    ...
                    <div className="mt-3 flex flex-wrap gap-1.5">
                        {asset.tags.slice(0, 3).map((tag) => (
                            <Tag key={typeof tag === "string" ? tag : tag.name} className="m-0 text-[11px]">
